...
- *ROC AUC: Evalúa la capacidad del modelo para distinguir entre clases (1 = perfecto, 0.5 = aleatorio).*
    ...
    ![image.png](attachment:b411d47a-d023-49ae-863a-1d6f9b11c66b:image.png)
...
- PR AUC: *Evalúa el área bajo la curva precision vs recall → Evalúa qué tan bien el modelo identifica los positivos verdaderos, prestando atención a los falsos positivos y falsos negativos.*
    ...
    ![image.png](attachment:10e3ba8d-905f-4345-8ba7-8e86dd31740a:image.png)
...
![image.png](attachment:1315413d-a771-421f-ac13-8c67a2c89d0d:image.png)
...
![image.png](attachment:dba103a2-261a-4fc7-b23e-c674a35dcab3:image.png)

![image.png](attachment:73f3dd2a-2778-4f89-8715-1ceb8c562668:image.png)
...
![image.png](attachment:caffac8e-9afb-4cd5-8259-28b779ed7a07:image.png)
...
- **SMOTE (Synthetic Minority Over-sampling Technique):**
    ...
    - **Limitación:** Puede crear muestras poco realistas en espacios de alta dimensión.
        ...
        ![image.png](attachment:b6123db7-3b70-4b1e-bf70-9674fa2c3485:image.png)
...
- **Técnicas avanzadas:**
    - **Tomek Links:** Elimina muestras cercanas al límite entre clases.
        ...
        ![image.png](attachment:890ba139-4fa3-467d-ac59-40d94e0765fc:image.png)
